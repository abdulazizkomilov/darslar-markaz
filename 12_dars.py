...
# #     print(talaba_0[key])
# # else:
# #     key = input("Bunday kalit so`z mavjud emas, iltimos kalit so`z va qiymat kiriting.\nKey>>> ")
# #     value = input("Value>>> ")
# #     talaba_0[key] = value
...
# buyurtma = []
# for n in range(1, 3):
#     buyurtma.append(input(f"{n}-buyurtmani kiriting: "))
# for buyum in buyurtma:
#     if buyum in mahsulotlar:
#         print(f"{buyum.title()} {mahsulotlar[buyum]} so'm")
#     else:
