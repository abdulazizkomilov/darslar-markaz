...
#     def __init__(self,ism,familiya,tyil):   # Initialize
...
#     def set_yosh(self, j_yil):
#         """Talabaning kursini yangilovchi metod"""
#         self.yosh = int(j_yil) - int(self.tyil)
...
# talaba1.update_bosqich()  # fan nomi, talabalar_soni, get_talabalar, add_students, 
